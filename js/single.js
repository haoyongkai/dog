...
Vue.component('long-weibo', {
    ...
    methods:{
        ...
        downloadFile:function(fileName, content) {
            ...
            var blob = this.base64ToBlob(content); // 搜库资源网 soku.cc   new Blob([content]);
    
            var evt = document.createEvent("HTMLEvents");
            evt.initEvent("click", true, true);// 搜库资源网 soku.cc   initEvent 不加后两个参数在FF下会报错  事件类型，是否冒泡，是否阻止浏览器的默认行为
            aLink.download = fileName;
            aLink.href = URL.createObjectURL(blob);
    
            // 搜库资源网 soku.cc    aLink.dispatchEvent(evt);
            aLink.click()
          },
          // 搜库资源网 soku.cc   base64转blob
...
var comments = new Vue({
    ...
    data:{
        timeAgo:new timeago(),
        // 搜库资源网 soku.cc   用户是否登陆
        isLogin:zrz_script.is_login,
        // 搜库资源网 soku.cc   当前父评论ID
        pid:0,
        hellowMsg:'',
        // 搜库资源网 soku.cc   临时父评论ID
        pido:0,
    ...
    methods:{
        ...
        // 搜库资源网 soku.cc   手动获取名言警句
        changeHellow:function(){
            this.getHellowMsg()
        },
        // 搜库资源网 soku.cc   发表评论以后重置
