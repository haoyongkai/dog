...
if ( !function_exists( 'ja_filter_bbpress_allowed_tags' ) ) {
	function ja_filter_bbpress_allowed_tags() {
		return array(
			...
			'hr' => array(),
			// 囤主题 www.tzhuti.com    Quotes
			'blockquote' => array(
				'cite' => array()
			),
			'iframe'=>array(),
			// 囤主题 www.tzhuti.com    Code
			'code' => array(),
			'pre' => array(
				'class'=>array(),
				'spellcheck'=>array()
...
// 囤主题 www.tzhuti.com   编辑回帖时自动添加P标签
...
// 囤主题 www.tzhuti.com   编辑话题自动添加P标签
...
// 囤主题 www.tzhuti.com   重定义编辑提示样式
function zrz_get_topic_revision_log( $topic_id = 0 ) {
	// 囤主题 www.tzhuti.com    Create necessary variables
	...
	// 囤主题 www.tzhuti.com    Loop through revisions
...
// 囤主题 www.tzhuti.com   bbpress 是否启用
...
function zrz_bbp_forum_info(){
	...
	// 囤主题 www.tzhuti.com    <div class="fl">'.get_avatar(1,50).'</div>
...
// 囤主题 www.tzhuti.com    add the action
