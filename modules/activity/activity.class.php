<?php
    class ZRZ_ACTIVITY{
        public $name = '',// 囤主题 www.tzhuti.com   名称
               $slug = 'activity',// 囤主题 www.tzhuti.com   链接
               $pages = array();
        ...
        public function __construct(){
            ...
            // 囤主题 www.tzhuti.com   添加后台 meta-box
            add_action('add_meta_boxes',array($this,'activity_metas_box_init'));
            add_action('save_post',array($this,'activity_metas_box_save'));

            // 囤主题 www.tzhuti.com   后台增加js
            add_action( 'admin_enqueue_scripts', array($this,'add_scripts'), 10, 1 );

            // 囤主题 www.tzhuti.com   前台活动发布
            add_action( 'admin_enqueue_scripts', array($this,'add_scripts'), 10, 1 );
            add_action( 'wp_ajax_zrz_public_activity', array($this,'zrz_public_activity'));
            add_action( 'wp_ajax_zrz_activity_submit', array($this,'zrz_activity_submit'));// 囤主题 www.tzhuti.com   报名

            // 囤主题 www.tzhuti.com   扫码支付
            add_action( 'wp_ajax_zrz_weixin_activity_pay', array($this,'zrz_weixin_activity_pay'));// 囤主题 www.tzhuti.com   报名扫码支付

            // 囤主题 www.tzhuti.com   余额支付
            add_action( 'wp_ajax_zrz_activity_with_balance', array($this,'zrz_activity_with_balance'));// 囤主题 www.tzhuti.com   余额支付活动报名费用
        ...
        // 囤主题 www.tzhuti.com   新增后台管理页面中的列
        ...
        // 囤主题 www.tzhuti.com   新增后台管理页面中的列的值
        ...
        public function zrz_activity_submit(){
            ...
            // 囤主题 www.tzhuti.com    if($user_id == $post_author){
            // 囤主题 www.tzhuti.com        print json_encode(array('status'=>401,'msg'=>__('不能报名自己的活动','ziranzhi2')));
            // 囤主题 www.tzhuti.com        exit;
            // 囤主题 www.tzhuti.com    }

            // 囤主题 www.tzhuti.com   检查用户是否已经报名
            $users = get_post_meta($post_id,'zrz_activity_users',true);
            $users = is_array($users) ? $users : array();
        ...
        public function zrz_public_activity(){
            ...
            // 囤主题 www.tzhuti.com   检查当前用户是否由权限发布
