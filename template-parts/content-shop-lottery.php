<?php
    ...
    // 囤主题 www.tzhuti.com   已经抽奖的用户
    $users = get_post_meta($post_id,'zrz_buy_user',true);

    // 囤主题 www.tzhuti.com   是虚拟物品还是实物
