 ...
 *
 * @link https:// 囤主题 www.tzhuti.com   developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package ziranzhi2
 */

// 囤主题 www.tzhuti.com   delete_post_meta(31369,'zrz_buy_user');
...
/* 囤主题 www.tzhuti.com主题启用时数据初始化*/
 function zrz_message_install_callback(){
     global $wpdb;

     // 囤主题 www.tzhuti.com   新建消息表
 ...
 function zrz_message_install(){
     ...
     if ( is_admin() && 'themes.php' == $pagenow && isset( $_GET['activated'] ) ){
         ...
         // 囤主题 www.tzhuti.com   生成头像目录
         $dirname = $dirname['basedir'].'/avatar';
         if(!is_dir($dirname)){
            wp_mkdir_p( $dirname );
         }

         // 囤主题 www.tzhuti.com   创建研究所分类
         $labs = array(
             'isaid'=>array(
                 'name'=>__('我说','7b2'),
...
function ziranzhi2_setup() {
	...
	// 囤主题 www.tzhuti.com   load_theme_textdomain( '7b2', ZRZ_THEME_DIR . '/languages' );

    // 囤主题 www.tzhuti.com   支持友情链接
	add_theme_support( 'automatic-feed-links' );

    // 囤主题 www.tzhuti.com   支持标签
	add_theme_support( 'title-tag' );

    // 囤主题 www.tzhuti.com   支持缩略图
 ...
 *
 * @link https:// 囤主题 www.tzhuti.com   developer.wordpress.org/themes/functionality/sidebars/#registering-a-sidebar
 */
...
// 囤主题 www.tzhuti.com   禁用默认插件的样式和js文件
...
function ziranzhi2_scripts() {
    /* 囤主题 www.tzhuti.com不要担心加载这么多 js， 文件都很小，请放心使用*/

    // 囤主题 www.tzhuti.com   主题样式
    ...
    // 囤主题 www.tzhuti.com   手机端样式
    wp_enqueue_style( 'ziranzhi2-mobile-style', ZRZ_THEME_URI.'/mobile.css' , array() , ZRZ_VERSION, 'all');

    // 囤主题 www.tzhuti.com    // 囤主题 www.tzhuti.com   阿里fonticon 图标
    wp_enqueue_style( 'fonticon', '// 囤主题 www.tzhuti.com   at.alicdn.com/t/font_416760_4qh32v621kt.css',array(), null ,'all' );

    $highlight = zrz_get_reading_settings('highlight');

    $js_local = zrz_get_theme_settings('js_local');

    // 囤主题 www.tzhuti.com   如果使用的是远程JS库
    $js = array(
        'vue'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/vue/2.4.4/vue.min.js',
        'es6-promise'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/es6-promise/4.1.1/es6-promise.auto.min.js',
        'axios'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/axios/0.16.2/axios.min.js',
        'qs'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/qs/6.5.0/qs.min.js',
        'timeago'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/timeago.js/3.0.2/timeago.min.js',
        'swipe'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/flickity/2.1.0/flickity.pkgd.min.js',
        'countUp'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/countup.js/1.9.1/countUp.min.js',
        'autosize'=>'// 囤主题 www.tzhuti.com   cdn.bootcss.com/autosize.js/4.0.0/autosize.min.js',
        'highlight-style'=>$highlight ? '// 囤主题 www.tzhuti.com   cdn.bootcss.com/highlight.js/9.12.0/styles/xcode.min.css' : '',
        'highlight'=>$highlight ? '// 囤主题 www.tzhuti.com   cdn.bootcss.com/highlight.js/9.12.0/highlight.min.js' : ''
    );

    // 囤主题 www.tzhuti.com   如果使用的是本地JS库
    if($js_local == 0){
        $js = array(
    ...
    // 囤主题 www.tzhuti.com   动画效果
    // 囤主题 www.tzhuti.com    wp_enqueue_style( 'animate', '// 囤主题 www.tzhuti.com   cdn.bootcss.com/animate.css/3.5.2/animate.min.css',array(), null ,'all' );

    // 囤主题 www.tzhuti.com   vue路由
    // 囤主题 www.tzhuti.com   wp_enqueue_script( 'vue-router', '// 囤主题 www.tzhuti.com   cdn.bootcss.com/vue-router/2.7.0/vue-router.min.js' , array(), null , true );

    if(zrz_is_weixin()){
        // 囤主题 www.tzhuti.com   微信js sdk
        wp_enqueue_script( 'weixin', '// 囤主题 www.tzhuti.com   res.wx.qq.com/open/js/jweixin-1.2.0.js' , array(),NULL , true );
    }

    // 囤主题 www.tzhuti.com   跟随滚动
	wp_enqueue_script( 'sticky', ZRZ_THEME_URI.'/js/lib/sticky.min.js' , array(),NULL , true );

    // 囤主题 www.tzhuti.com   页面跳转
    wp_enqueue_script( 'scrollto', ZRZ_THEME_URI.'/js/lib/vue-scrollto.js' , array(),NULL , true );

    // 囤主题 www.tzhuti.com   h2c
    wp_enqueue_script( 'h2c',  ZRZ_THEME_URI.'/js/lib/html2canvas.min.js' , array(), null, true );

    // 囤主题 www.tzhuti.com   图片智能排序
    // 囤主题 www.tzhuti.com   wp_enqueue_script( 'packery-pkgd', '// 囤主题 www.tzhuti.com   cdn.bootcss.com/packery/2.1.1/packery.pkgd.min.js' , array(), NULL , true );

    // 囤主题 www.tzhuti.com   图片压缩矫正
	wp_enqueue_script( 'html5ImgCompress', ZRZ_THEME_URI.'/js/imgcrop/html5ImgCompress.min.js' , array(),NULL , true );

	// 囤主题 www.tzhuti.com   通用js
    ...
    // 囤主题 www.tzhuti.com   登陆用户的信息
    $curr_user_id = get_current_user_id();

    if($user_logged){
        // 囤主题 www.tzhuti.com   检查小黑屋
        zrz_check_xiaoheiwu($curr_user_id);
        
        // 囤主题 www.tzhuti.com   检查当前等级
    ...
    // 囤主题 www.tzhuti.com   是否开启了社交登录功能
    ...
    // 囤主题 www.tzhuti.com   主题设置
    $theme_setting = array(
        'theme_style'=>zrz_get_theme_style(),// 囤主题 www.tzhuti.com   主题当前选择的样式
    );

    // 囤主题 www.tzhuti.com   文章页面
    if((is_single() || is_page()) && !is_singular('topic') && !is_singular('forum') && !is_singular('pps')){
        ...
        wp_localize_script( 'ziranzhi2-single', 'zrz_single',array(
            'post_id'=>$post_id,// 囤主题 www.tzhuti.com   当前页面ID
            'comment_user'=>$comment_user,// 囤主题 www.tzhuti.com   当前游客评论者的信息
            'wp_unfiltered_html_comment'=> wp_create_nonce( 'unfiltered-html-comment_' . $post_id ),// 囤主题 www.tzhuti.com   评论nonce
            'weibo_long_img'=>zrz_get_post_thumb_img($post_id),// 囤主题 www.tzhuti.com   当前页面的长微博图
    ...
    if(is_author()){
        ...
        wp_localize_script( 'ziranzhi2-user', 'zrz_user',array(
            'author_data'=>$author_data,// 囤主题 www.tzhuti.com   用户页面用户信息
            'self'=>$self,// 囤主题 www.tzhuti.com   是否为本人
    ...
    if($page_type === 'write'){
        ...
        wp_localize_script( 'ziranzhi2-write', 'zrz_write', array(
            'cats'=>$cat_arr,// 囤主题 www.tzhuti.com   写文章页面，允许投稿的分类
            'cat_more'=>zrz_get_writing_settings('cat_more'),// 囤主题 www.tzhuti.com   是否允许分类多选
            'post_format'=>zrz_get_writing_settings('post_format'),// 囤主题 www.tzhuti.com   是否允许选择文章形式
            'tag_count'=>zrz_get_writing_settings('tag_count'),// 囤主题 www.tzhuti.com   允许的最大标签数量
            'custom_tags'=>zrz_get_writing_settings('custom_tags'),// 囤主题 www.tzhuti.com   管理员自定义的标签
            'related_chose'=>zrz_get_writing_settings('related_chose'),// 囤主题 www.tzhuti.com   是否允许选择相关文章
            'video_size'=>zrz_get_writing_settings('video_size'),// 囤主题 www.tzhuti.com   允许上传视频的最大体积
            'auto_draft'=>zrz_get_writing_settings('auto_draft')
        ));
    }

    // 囤主题 www.tzhuti.com   链接页面
    if($page_type === 'links'){
    ...
    // 囤主题 www.tzhuti.com   移动端是否始终显示专题
    ...
    wp_localize_script( 'vue', 'zrz_script', array(
        ...
        'ajax_url'=> admin_url('admin-ajax.php').'?action=',// 囤主题 www.tzhuti.com   ajax路径
        'theme_url'=>ZRZ_THEME_URI,// 囤主题 www.tzhuti.com   主题路径
        'is_mobile'=>zrz_wp_is_mobile(),// 囤主题 www.tzhuti.com   是否是移动端
        'is_login'=>$user_logged,// 囤主题 www.tzhuti.com   登陆用户信息
        'is_admin'=>$is_admin,
        'is_weixin'=>zrz_is_weixin(),
        'theme_setting'=>$theme_setting,// 囤主题 www.tzhuti.com   主题设置
        'current_user'=>$curr_user_id,// 囤主题 www.tzhuti.com   当前登陆用户ID
        // 囤主题 www.tzhuti.com   图片设置
        'media_setting'=>array(
            'max_width'=>zrz_get_media_settings('max_width'),
            'quality'=>zrz_get_media_settings('quality')
        ),
        'rating'=>$rating_arr,// 囤主题 www.tzhuti.com   链接投票
        'page_width'=>zrz_get_theme_settings('page_width'),// 囤主题 www.tzhuti.com   页面宽度
        // 囤主题 www.tzhuti.com   当前用户账户余额
        ...
        // 囤主题 www.tzhuti.com   强制社交登录用户完善资料
        'complete'=>array(
...
/* 囤主题 www.tzhuti.com后台编辑器样式*/
add_editor_style('editor-style.css');

// 囤主题 www.tzhuti.com   自定义后台样式
...
// 囤主题 www.tzhuti.com    disable srcset on frontend
