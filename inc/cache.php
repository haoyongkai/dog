...
/* 囤主题 www.tzhuti.com
    侧边栏小工具缓存插件
	Version: 0.5.2
	GitHub URI: https:// 囤主题 www.tzhuti.com   github.com/kasparsd/widget-output-cache
	Author: Kaspars Dambis
	Author URI: http:// 囤主题 www.tzhuti.com   kaspars.net
*/
...
class WidgetOutputCache {
	...
	// 囤主题 www.tzhuti.com    Store IDs of widgets to exclude from cache
	private $excluded_ids = array();


	protected function __construct() {

		// 囤主题 www.tzhuti.com    Overwrite widget callback to cache the output
		add_filter( 'widget_display_callback', array( $this, 'widget_callback' ), 10, 3 );

		// 囤主题 www.tzhuti.com    Cache invalidation for widgets
		add_filter( 'widget_update_callback', array( $this, 'cache_bump' ) );

		// 囤主题 www.tzhuti.com    Allow widgets to be excluded from the cache
		add_action( 'in_widget_form', array( $this, 'widget_controls' ), 10, 3 );

		// 囤主题 www.tzhuti.com    Load widget cache exclude settings
		add_action( 'init', array( $this, 'init' ), 10 );

		// 囤主题 www.tzhuti.com    Save widget cache settings
	...
	function widget_callback( $instance, $widget_object, $args ) {
		...
		// 囤主题 www.tzhuti.com    Don't return the widget
		...
		// 囤主题 www.tzhuti.com    We already echoed the widget, so return false
		return false;
	...
	function save_widget_controls() {
		...
		// 囤主题 www.tzhuti.com    current_user_can( 'edit_theme_options' ) is already being checked in widgets.php
		...
		if ( ! isset($_POST['delete_widget']) && $is_excluded ) {
			...
			// 囤主题 www.tzhuti.com    Wiget is being saved and it is being excluded too
			$this->excluded_ids[] = $widget_id;

		} elseif ( in_array( $widget_id, $this->excluded_ids ) ) {

			// 囤主题 www.tzhuti.com    Widget is being removed, remove it from exclusions too
