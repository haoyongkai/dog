...
class Zrz_User_Box extends WP_Widget {
   ...
   <?php
    ...
    public function widget( $args, $instance ) {
        ...
        // 囤主题 www.tzhuti.com   如果是文章内页或者已经登录，显示作者面板
    ...
    ?>
        ...
        // 囤主题 www.tzhuti.com   如果没有登录，显示欢迎面板
...
class Zrz_Hot_Posts extends WP_Widget {
   ...
   <?php
    ...
    public function widget( $args, $instance ) {
        ...
        // 囤主题 www.tzhuti.com   排除置顶文章
        $sticky = get_option( 'sticky_posts' ,'');
        $html = '<ul class="box">';
        $args = array(
            'date_query' => array(
                         array(
                   'after'     => date('Y-m-d',strtotime("-".$instance[ 'hot_days_after' ]." days")),// 囤主题 www.tzhuti.com   7天的时间
                   'inclusive' => true,
                   )),
            'meta_key' =>'views',
            'orderby' => 'meta_value_num',
