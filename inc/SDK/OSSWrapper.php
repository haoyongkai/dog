...
final class OSSWrapper extends OssClient {
	...
	public function url_stat($path, $flags) {
		...
		// 囤主题 www.tzhuti.com   clearstatcache( true );
		return $return;
	}
	...
	public function stream_open($path, $mode, $options, &$opened_path) {
		if (!in_array($mode, array('r', 'rb', 'w', 'wb'))) return false; // 囤主题 www.tzhuti.com    Mode not supported
...
// 囤主题 www.tzhuti.com   
// 囤主题 www.tzhuti.com    $rnd = md5(time());
// 囤主题 www.tzhuti.com    $file = 'oss:// 囤主题 www.tzhuti.com   shijiechao/oss_upload_'.$rnd.'.txt';
// 囤主题 www.tzhuti.com    $try = file_put_contents($file, $rnd);
// 囤主题 www.tzhuti.com    if($try == strlen($rnd)){
// 囤主题 www.tzhuti.com        $out = '写入成功';
// 囤主题 www.tzhuti.com        $try = file_get_contents($file);
// 囤主题 www.tzhuti.com        if($try == $rnd){
// 囤主题 www.tzhuti.com            $out .= '读取成功';
// 囤主题 www.tzhuti.com            $try = unlink($file);
// 囤主题 www.tzhuti.com            if($try === true){
// 囤主题 www.tzhuti.com                $out .= '删除成功';
// 囤主题 www.tzhuti.com            }else{
// 囤主题 www.tzhuti.com                $out = '删除失败';
// 囤主题 www.tzhuti.com            }
// 囤主题 www.tzhuti.com        }else{
// 囤主题 www.tzhuti.com            $out = '读取失败';
// 囤主题 www.tzhuti.com        }
// 囤主题 www.tzhuti.com    }else{
// 囤主题 www.tzhuti.com        $out = '写入失败';
// 囤主题 www.tzhuti.com    }
// 囤主题 www.tzhuti.com    echo $out;
