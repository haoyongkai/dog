...
class Payjs
{
    private $url = 'https:// 囤主题 www.tzhuti.com   payjs.cn/api/native';
    private $key;            // 囤主题 www.tzhuti.com    填写通信密钥
    private $mchid;          // 囤主题 www.tzhuti.com    特写商户号
  	private $inweixin;
    private $callback;
    ...
    public function pay(){
        ...
        if($this->inweixin){
            return 'https:// 囤主题 www.tzhuti.com   payjs.cn/api/cashier?' . http_build_query($data);
        }else{
