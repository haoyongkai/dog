...
class BankGateway extends Wechat
{
    ...
    protected $gateway_query = 'https:// 囤主题 www.tzhuti.com   api.mch.weixin.qq.com/mmpaysptrans/query_bank';
    ...
    protected function getRsaContent()
    {
        ...
        $url = 'https:// 囤主题 www.tzhuti.com   fraud.mch.weixin.qq.com/risk/getpublickey';
