...
abstract class Alipay extends GatewayInterface
{
     ...
     * @var string
     */
    protected $gateway = 'https:// 囤主题 www.tzhuti.com   openapi.alipay.com/gateway.do?charset=utf-8';
    ...
    public function __construct(array $config)
    {
        ...
        if (!empty($config['debug'])) {
            $this->gateway = 'https:// 囤主题 www.tzhuti.com   openapi.alipaydev.com/gateway.do?charset=utf-8';
        }
        $this->config = [
