...
function zrz_pps_taxonomy(){
    ...
    $args = array(
            'labels' => $labels,
            'hierarchical' => true,// 囤主题 www.tzhuti.com   分层级
			'singular_label' => 'mp',
			'labels'                => $labels,
			'show_ui'               => true,
...
function zrz_add_bubble(){
    ...
    // 囤主题 www.tzhuti.com   检查用户发布冒泡的权限
