...
class ZRZ_USER_LV{
    ...
    public function set_lv($set_lv = '',$set_vip = false){
        ...
        // 囤主题 www.tzhuti.com   如果未曾达到这个积分等级才会升级
...
// 囤主题 www.tzhuti.com   检查用户是否有某个权限
...
// 囤主题 www.tzhuti.com   检查当前用户是否有某个权限
