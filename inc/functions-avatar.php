...
class Get_Letter_Avatar{
	...
	public function get_letter_avatar(){
		...
		// 囤主题 www.tzhuti.com   如果没有安装 GD 返回空
		if(!function_exists('imagecreate')) return '';

		$avatar = '';

		// 囤主题 www.tzhuti.com   获取文字
		$letter = self::get_letter();

		// 囤主题 www.tzhuti.com   如果头像存在，直接返回头像
		...
		// 囤主题 www.tzhuti.com   创建一个 100*100 的空白图像
		$image = imagecreatetruecolor(300,300);

		// 囤主题 www.tzhuti.com   背景颜色
		$bgcolor = imagecolorallocate($image,255,255,255);

		// 囤主题 www.tzhuti.com   设置透明
		imagecolortransparent($image,$bgcolor);

		// 囤主题 www.tzhuti.com   填充到图像中
		imagefill($image,0,0,$bgcolor);

		// 囤主题 www.tzhuti.com   字体路径
		$font = dirname(__FILE__).DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR.'SourceHanSansCN-Normal.ttf';

		// 囤主题 www.tzhuti.com   字体颜色
		$fontcolor = imagecolorallocate($image,250,250,250);

		// 囤主题 www.tzhuti.com   获取字体的真实宽高
		...
		// 囤主题 www.tzhuti.com   坐标
		$x = 148-($txtw/2);
		$y = 150-($txth/2);
		$anger = 0;

		// 囤主题 www.tzhuti.com   生成字体
	...
	// 囤主题 www.tzhuti.com   获取第一个字符，或者最后一个字符
	public function get_letter(){
		...
		// 囤主题 www.tzhuti.com   如果不存在则返回文字“空”
		if(!$name && $name != 0){
			$name = '空';
		}
...
// 囤主题 www.tzhuti.com   后台设置项中不显示自定义的头像
