<?php
    // 囤主题 www.tzhuti.com   浏览器是否支持 webp 格式的图片？
    ...
    */
    function zrz_get_thumb($thumb,$width='160',$height='100',$crop_y = 0,$crop_only = false,$gif = true){
        ...
        // 囤主题 www.tzhuti.com   quality 为要生成图片的质量 0-100，默认96
        if($height == 'full'){
        ...
        // 囤主题 www.tzhuti.com   如果是字母头像，直接返回
    ...
    */
    function zrz_get_post_thumb($post_id = 0,$type = false){
        ...
        // 囤主题 www.tzhuti.com   如果存在特色图，则返回特色图
        if($post_thumbnail_url){
            return esc_url($post_thumbnail_url);
        }

        // 囤主题 www.tzhuti.com   如果没有特色图则返回文章第一张图片
        if(!$type){
