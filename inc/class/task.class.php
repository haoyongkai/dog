...
class ZRZ_TASK{
    ...
    // 囤主题 www.tzhuti.com   检查任务
    public function check_task(){
        if($this->type === '') return true;
        $count = $this->task_data[$this->type];

        // 囤主题 www.tzhuti.com   当前任务完成数量
        $count = $count['count'];

        // 囤主题 www.tzhuti.com   设置的数量
