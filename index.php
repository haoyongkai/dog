...
<div id="primary-home" class="content-area fd mobile-full-width <?php echo $show_sidebar ? '' : 'w100'; ?>" ref="primaryHome" data-paged="<?php echo $ipaged; ?>" data-pages="<?php echo $ipages; ?>">
	...
	if ( have_posts() ) :
		...
		// 囤主题 www.tzhuti.com    $open_ads_list = zrz_get_ads_settings('home_list');
		// 囤主题 www.tzhuti.com    $open_ads_card = zrz_get_ads_settings('home_card');
		// 囤主题 www.tzhuti.com   
		// 囤主题 www.tzhuti.com    $open_ads_list = $open_ads_list['open'] && $theme_style === 'list' ? 1 : 0;
		// 囤主题 www.tzhuti.com    $open_ads_card = $open_ads_card['open'] && $theme_style === 'pinterest' ? 1 : 0;
