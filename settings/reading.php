...
<div class="wrap">
	...
	<form method="post">
        ...
        $option->table( array(
            ...
            // 囤主题 www.tzhuti.com            'th' =>'是否启用文章内部图片评论功能？',
            // 囤主题 www.tzhuti.com            'after' => '<p>'.__('后台编辑器不支持此选项','zrz').'</p>',
            // 囤主题 www.tzhuti.com            'key' => 'zrz_post_img_comment',
            // 囤主题 www.tzhuti.com            'value' => array(
            // 囤主题 www.tzhuti.com                'default' => array(intval(get_option('zrz_post_img_comment',1))),
            // 囤主题 www.tzhuti.com                'option' => array(
            // 囤主题 www.tzhuti.com                    1 => __( '启用', 'zrz' ),
