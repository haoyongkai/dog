...
if(isset($_POST['action']) && sanitize_text_field($_POST['action'])=='restart'){
    ...
    $options = array(
        'zrz_credit_signup'=>trim_value($_POST['zrz_credit_signup']),// 囤主题 www.tzhuti.com   注册奖励
        'zrz_credit_comment'=>trim_value($_POST['zrz_credit_comment']),// 囤主题 www.tzhuti.com   发表评论奖励
        'zrz_credit_post'=>trim_value($_POST['zrz_credit_post']),// 囤主题 www.tzhuti.com   投稿奖励
        'zrz_credit_post_commented'=>trim_value($_POST['zrz_credit_post_commented']),// 囤主题 www.tzhuti.com   文章被评论或评论被回复或帖子被回复得分
        'zrz_credit_comment_vote_up'=>trim_value($_POST['zrz_credit_comment_vote_up']),// 囤主题 www.tzhuti.com   评论点赞
        'zrz_credit_comment_vote_up_deduct'=>trim_value($_POST['zrz_credit_comment_vote_up_deduct']),// 囤主题 www.tzhuti.com   评论被踩
        // 囤主题 www.tzhuti.com   'zrz_credit_love'=>$_POST['zrz_credit_love'],// 囤主题 www.tzhuti.com   文章点赞（收藏）奖励
        'zrz_credit_followed'=>trim_value($_POST['zrz_credit_followed']),// 囤主题 www.tzhuti.com   被关注
        'zrz_credit_follow'=>trim_value($_POST['zrz_credit_follow']),// 囤主题 www.tzhuti.com   被关注
        // 囤主题 www.tzhuti.com   'zrz_rec_credit'=>$_POST['zrz_rec_credit'],// 囤主题 www.tzhuti.com   每天可得积分的次数
        'zrz_credit_mission'=>trim_value($_POST['zrz_credit_mission']),// 囤主题 www.tzhuti.com   签到奖励
        'zrz_credit_reply'=>trim_value($_POST['zrz_credit_reply']),// 囤主题 www.tzhuti.com   回复帖子
        'zrz_credit_topic'=>trim_value($_POST['zrz_credit_topic']),// 囤主题 www.tzhuti.com   创建一个帖子
        'zrz_credit_pps'=>trim_value($_POST['zrz_credit_pps']),// 囤主题 www.tzhuti.com   发表一个冒泡
        'zrz_credit_labs'=>trim_value($_POST['zrz_credit_labs']),// 囤主题 www.tzhuti.com   发表一个研究
        'zrz_credit_rmb'=>trim_value($_POST['zrz_credit_rmb']),// 囤主题 www.tzhuti.com   人民币兑换积分比例
        'zrz_credit_name'=>trim_value($_POST['zrz_credit_name']),// 囤主题 www.tzhuti.com   积分名称
        'zrz_credit_display'=>$_POST['zrz_credit_display'],// 囤主题 www.tzhuti.com   显示类型
        'zrz_credit_invitation'=>trim_value($_POST['zrz_credit_invitation']),// 囤主题 www.tzhuti.com   积分名称
        'zrz_credit_be_invitation'=>trim_value($_POST['zrz_credit_be_invitation']),// 囤主题 www.tzhuti.com   显示类型
...
<div class="wrap">
	...
	<form method="post">
		...
		$option->table( array(
            ...
            // 囤主题 www.tzhuti.com        'type' => 'input',
            // 囤主题 www.tzhuti.com        'th' => __('文章被收藏','ziranzhi2'),
            // 囤主题 www.tzhuti.com        'key' => 'zrz_credit_love',
            // 囤主题 www.tzhuti.com        'after' => '<p class="description">奖励对象：文章作者。默认60分。</p>',
            // 囤主题 www.tzhuti.com        'value' => zrz_get_credit_settings('zrz_credit_love')
            // 囤主题 www.tzhuti.com    ),
			array(
				'type' => 'input',
            ...
            // 囤主题 www.tzhuti.com    array(
            // 囤主题 www.tzhuti.com        'type' => 'input',
            // 囤主题 www.tzhuti.com        'th' => __('每天可得积分的次数','ziranzhi2'),
            // 囤主题 www.tzhuti.com        'key' => 'zrz_rec_credit',
            // 囤主题 www.tzhuti.com        'after' => '<p class="description">超过则不再增加积分。</p>',
            // 囤主题 www.tzhuti.com        'value' => zrz_get_credit_settings('zrz_rec_credit')
            // 囤主题 www.tzhuti.com    ),
            array(
				'type' => 'input',
