  ...
  if( isset($_POST['action']) && sanitize_text_field($_POST['action'])=='update' && wp_verify_nonce( trim($_POST['_wpnonce']), 'check-nonce' ) ) :
    ...
    $options = array(
        'alipay'=>array(
            ...
            'appid'=>trim_value($_POST['zrz_alipay_appid']),// 囤主题 www.tzhuti.com   支付宝支付应用的appid
            'saPrivateKey'=>trim_value($_POST['zrz_alipay_saPrivateKey']),// 囤主题 www.tzhuti.com   商户私钥，填写对应签名算法类型的私钥，默认 RSA2 算法
        ...
        'weixin'=>array(
            ...
            'gz_appid'=>trim_value($_POST['weixin_gz_appid']),// 囤主题 www.tzhuti.com   微信公众号的appid
            'mch_id'=>trim_value($_POST['weixin_mch_id']),// 囤主题 www.tzhuti.com   微信商户号
            'mch_key'=>trim_value($_POST['weixin_mch_key']),// 囤主题 www.tzhuti.com   微信支付密钥
...
<div class="wrap">
	...
	<form method="post">
        ...
        <p>设置之前，请仔细阅读说明，按照步骤来：<a target="_blank" href="https:// 囤主题 www.tzhuti.com   7b2.com/29685.html">支付宝支付的申请与设置步骤</a></p>
		<?php
    		$option->table(array(
                array(
                    'type' => 'select',
                ...
                array(
                    ...
                    'after' =>'<p class="description">打开链接： <code>https:// 囤主题 www.tzhuti.com   open.alipay.com</code> 账户中心->密钥管理->开放平台密钥，填写添加了电脑网站支付的应用的APPID</p>',
                ...
                array(
                    ...
                    'after' =>'<p class="description"> 本主题使用的是 <b style="color:red">RSA2</b> 算法生成的私钥。请使用 RSA2 算法来生成。<br>教程：<code>https:// 囤主题 www.tzhuti.com   docs.open.alipay.com/291/105971</code> 和 <code>https:// 囤主题 www.tzhuti.com   docs.open.alipay.com/200/105310</code></p>',
        ...
        <p>设置之前，请仔细阅读说明，按照步骤来：<a target="_blank" href="https:// 囤主题 www.tzhuti.com   7b2.com/29685.html">微信支付的申请与设置步骤</a></p>
		<?php
        ...
        <p style="color:red">微信支付的第三方服务，支持个人支付，申请地址：<a href="https:// 囤主题 www.tzhuti.com   payjs.cn/ref/DYXQLZ" target="_blank">payjs.cn</a>。</p>
        <?php
    		$option->table(array(
                array(
                    'type' => 'select',
        ...
        <p style="color:red">迅虎网络的第三方集成服务，支持支付宝、微信个人免签，申请地址：<a href="http:// 囤主题 www.tzhuti.com   mp.wordpressopen.com" target="_blank">迅虎支付</a>。</p>
        <?php
...
?>
        ...
        <p style="color:red">虎皮椒支付-微信支付，申请地址：<a href="https:// 囤主题 www.tzhuti.com   admin.xunhupay.com/sign-up/6474.html" target="_blank">虎皮椒V3</a>。</p>
        <?php
        ...
        <p style="color:red">虎皮椒支付-支付宝支付，申请地址：<a href="https:// 囤主题 www.tzhuti.com   admin.xunhupay.com/sign-up/6474.html" target="_blank">虎皮椒V3</a>。</p>
        <?php
            $hupijiao = zrz_get_pay_settings('hupijiao');
    		$option->table(array(
                array(
        ...
        <p style="color:red">有赞支付的第三方集成服务，支持支付宝、微信个人免签，详细教程，请查看：<a href="https:// 囤主题 www.tzhuti.com   7b2.com/31756.html" target="_blank">有赞支付设置教程</a>。</p>
        <?php
