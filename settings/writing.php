...
function zrz_options_writing_page(){
    ...
    if( isset($_POST['action']) && sanitize_text_field($_POST['action'])=='update' && wp_verify_nonce( trim($_POST['_wpnonce']), 'check-nonce' ) ) :
        ...
        $options = array(
                'cat'=>isset($_POST['cat']) && !empty($_POST['cat']) ? $_POST['cat'] : array(1),// 囤主题 www.tzhuti.com   允许投稿的分类
                'cat_more'=>$_POST['cat_more'],// 囤主题 www.tzhuti.com   允许投稿的分类
                'min_strlen'=>trim_value($_POST['min_strlen']),// 囤主题 www.tzhuti.com   投稿最少字数
                'max_strlen'=>trim_value($_POST['max_strlen']),// 囤主题 www.tzhuti.com   投稿最多字数
                'post_format'=>$_POST['post_format'],// 囤主题 www.tzhuti.com   是否允许用户选择文章形式
                'tag_count'=>trim_value($_POST['tag_count']),// 囤主题 www.tzhuti.com   允许输入的标签最大数
                'custom_tags'=>$custom_tags,// 囤主题 www.tzhuti.com   管理员自定义的标签
                'video_size'=>trim_value($_POST['video_size']),// 囤主题 www.tzhuti.com   允许上传的视频体积
                'status'=>$_POST['status'],// 囤主题 www.tzhuti.com   投稿后的状态
                'edit_time'=>trim_value($_POST['edit_time']),// 囤主题 www.tzhuti.com   多长时间内允许编辑
                'related_chose'=>$_POST['related_chose'],// 囤主题 www.tzhuti.com   是否允许选择相关文章
                'labs_status'=>$_POST['labs_status'],// 囤主题 www.tzhuti.com   投稿后的状态
                'labs_edit_time'=>trim_value($_POST['labs_edit_time']),// 囤主题 www.tzhuti.com   多长时间内允许编辑
                'auto_draft'=>$_POST['auto_draft'],// 囤主题 www.tzhuti.com   多长时间内允许编辑
                // 囤主题 www.tzhuti.com    'allow_fj'=>$_POST['allow_fj'],
                // 囤主题 www.tzhuti.com    'allow_video'=>$_POST['allow_video'],
                // 囤主题 www.tzhuti.com    'fj_open'=>$_POST['fj_open']
            );
...
<div class="wrap">
	...
	<form method="post">
		...
		$option->table( array(
            ...
            // 囤主题 www.tzhuti.com        'th' => __('是否允许用户上传视频？','ziranzhi2'),
            // 囤主题 www.tzhuti.com        'key' => 'allow_video',
            // 囤主题 www.tzhuti.com        'value' => array(
            // 囤主题 www.tzhuti.com            'default' => array(zrz_get_writing_settings('allow_video')),
            // 囤主题 www.tzhuti.com            'option' => array(
            // 囤主题 www.tzhuti.com                1 => __( '允许', 'ziranzhi2' ),
            // 囤主题 www.tzhuti.com                0 => __( '禁止', 'ziranzhi2' )
            // 囤主题 www.tzhuti.com            )
            // 囤主题 www.tzhuti.com        )
            // 囤主题 www.tzhuti.com    ),
            // 囤主题 www.tzhuti.com    array(
            // 囤主题 www.tzhuti.com        'type' => 'select',
            // 囤主题 www.tzhuti.com        'th' => __('是否允许用户上传附件？','ziranzhi2'),
            // 囤主题 www.tzhuti.com        'key' => 'allow_fj',
            // 囤主题 www.tzhuti.com        'value' => array(
            // 囤主题 www.tzhuti.com            'default' => array(zrz_get_writing_settings('allow_fj')),
            // 囤主题 www.tzhuti.com            'option' => array(
            // 囤主题 www.tzhuti.com                1 => __( '允许', 'ziranzhi2' ),
            // 囤主题 www.tzhuti.com                0 => __( '禁止', 'ziranzhi2' )
            // 囤主题 www.tzhuti.com            )
            ...
            // 囤主题 www.tzhuti.com    array(
            // 囤主题 www.tzhuti.com        'type' => 'select',
            // 囤主题 www.tzhuti.com        'th' => __('附件下载新窗口打开？','ziranzhi2'),
            // 囤主题 www.tzhuti.com        'key' => 'fj_open',
            // 囤主题 www.tzhuti.com        'value' => array(
            // 囤主题 www.tzhuti.com            'default' => array(zrz_get_writing_settings('fj_open')),
            // 囤主题 www.tzhuti.com            'option' => array(
            // 囤主题 www.tzhuti.com                1 => __( '直接下载', 'ziranzhi2' ),
            // 囤主题 www.tzhuti.com                0 => __( '新窗口打开下载', 'ziranzhi2' )
            // 囤主题 www.tzhuti.com            )
            // 囤主题 www.tzhuti.com        )
            // 囤主题 www.tzhuti.com    ),
		) );
