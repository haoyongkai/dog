...
function zrz_options_social_page(){
    ...
    if( isset($_POST['action']) && sanitize_text_field($_POST['action'])=='update' && wp_verify_nonce( trim($_POST['_wpnonce']), 'check-nonce' ) ) :
        ...
        $options = array(
            ...
            'open_weibo'=>$_POST['open_weibo'],// 囤主题 www.tzhuti.com   是否启用微博登陆
            ...
            'complete_material'=>$_POST['complete_material'],// 囤主题 www.tzhuti.com   是否需要强制用户完善资料
            'open_new_window'=> $_POST['open_new_window'],// 囤主题 www.tzhuti.com   是否在新窗口打开
            'type'=>$_POST['type'],// 囤主题 www.tzhuti.com   1使用邮箱验证，2使用短信验证，3邮箱和短信均可验证
...
<div class="wrap">
	...
	<form method="post">
		...
		?>
        <h3>社交登录申请</h3>
        <p class="description" style="color:red">QQ登录申请地址：<a href="https:// 囤主题 www.tzhuti.com   connect.qq.com/" target="_blank">https:// 囤主题 www.tzhuti.com   connect.qq.com/</a></p>
        <p class="description" style="color:red">微博登录申请地址：<a href="http:// 囤主题 www.tzhuti.com   open.weibo.com/development" target="_blank">http:// 囤主题 www.tzhuti.com   open.weibo.com/development</a></p>
        <p class="description" style="color:red">微信登录的申请地址<a target="_blank" href="https:// 囤主题 www.tzhuti.com   open.weixin.qq.com/">https:// 囤主题 www.tzhuti.com   open.weixin.qq.com/</a></p>

        <h3>回调地址的填写方式</h3>
        <p class="description" style="color:red">QQ和微博的回调地址请填写：<?php echo home_url('/open'); ?></p>
        <p class="description"><span style="color:red">微信的回调地址请填写：<?php echo str_replace(array('http:// 囤主题 www.tzhuti.com   ','https:// 囤主题 www.tzhuti.com   '),'',home_url()); ?></span>（请注意没有http:// 囤主题 www.tzhuti.com    或 https:// 囤主题 www.tzhuti.com   ）</p>
        ...
        <?php
            $option->table( array(
                ...
                array(
                    ...
                    'after' => '<p>例如：</p><p><code>http:// 囤主题 www.tzhuti.com   xxxx.com/xxx|获取</code></p>',
                    'key' => 'invitation_text',
            ...
            <div id="aliyun-set">
                ...
                ?>
                <p class="description" style="color:red">如果开启了手机注册请填写。短信服务申请地址：<a href="https:// 囤主题 www.tzhuti.com   www.aliyun.com/product/sms?spm=5176.8142029.388261.388.e93976f4ow0JNw" target="_blank">短信服务-阿里云</a></p>
            </div>
            <div id="yunpian-set">
                <?php
                ...
                ?>
                <p>一小时内同一号码、同一类型的验证码不能发送超过3次！申请地址：<a target="_blank" href="https:// 囤主题 www.tzhuti.com   www.yunpian.com/">https:// 囤主题 www.tzhuti.com   www.yunpian.com/</a></p>
            </div>
            ...
            <div id="juhe-set">
                ...
                ?>
                <p>申请地址：<a target="_blank" href="https:// 囤主题 www.tzhuti.com   www.juhe.cn/docs/api/id/54">https:// 囤主题 www.tzhuti.com   www.juhe.cn/docs/api/id/54</a></p>
            </div>
